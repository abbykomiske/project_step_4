...
<!-- 2024-04-29: When you draft your prospectus, you will want to include reference to this other research and summarize the goals and findings to show that the area has been explored to some extent. -->
...
<!-- 2024-04-29: Yes, it very much seems correct. -->
...
<!-- 2024-04-29: Good to start thinking about these possible features. Are there some features that are most likely to be associated with the outcome? Are these based on a hunch or is there literature that suggests that these features are potentially relevant?

I thought that your outcome was categorical (court decision)? If not, what is the continuous variable that you are predicting?
...
<!-- Yes, there is a lot to consider. Primarily at this point, what the potential features that will be useful and/ or insightful will be. -->
...
I am slightly concerned with feasibility, but I will ask more about this when I present on May ~~5th~~ 1st. <!-- :) -->
